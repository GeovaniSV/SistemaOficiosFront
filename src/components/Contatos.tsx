...
export const initialMockContatos = [
  ...
  },
  {
    ...
    email: "gabinete@mec.gov.br",
    type: "PJ",
    phone: "(61) 2022-8000",
    document: "00.394.445/0001-85",
    cep: "70047-900",
    ...
    responsibles: [
      {
        id: 1,
        departamento: "Gabinete do Ministro",
        nome: "Camilo Santana",
      ...
      {
        id: 2,
        departamento: "Secretaria de Educação Superior",
        nome: "",
        cargo: "Secretário de Educação Superior",
        tratamento: "Ilustríssimo Senhor",
      },
    ],
  },
  {
    id: 4,
    name: "Tribunal de Justiça do Estado",
    email: "presidencia@tjsp.jus.br",
    type: "PJ",
    phone: "(11) 3117-2200",
    document: "51.174.001/0001-93",
    cep: "01008-010",
    ...
    responsibles: [
      {
        ...
        tratamento: "Excelentíssimo Senhor Desembargador",
      },
      {
        id: 2,
        departamento: "Diretoria do Fórum",
        nome: "Dr. João da Silva",
        cargo: "Juiz Diretor do Fórum",
        tratamento: "Meritíssimo Juiz",
      },
    ],
  },
  {
    ...
    email: "roberto.alves@advocacia.com.br",
    type: "PF",
    phone: "(11) 98765-4321",
  ...
  },
  {
    ...
    email: "diretoria@hc.fm.usp.br",
    type: "PJ",
    phone: "(11) 2661-0000",
    document: "60.444.444/0001-22",
    cep: "05403-000",
    logradouro: "Av. Dr. Enéas Carvalho de Aguiar",
    numero: "255",
    ...
    responsibles: [
      {
        ...
        nome: "",
        cargo: "Reitor(a)",
        tratamento: "Magnífico(a) Reitor(a)",
      },
      {
        id: 2,
        departamento: "Pró-Reitoria de Extensão",
        nome: "",
    ...
    responsibles: [
      {
        ...
        tratamento: "Professora Doutora",
      },
    ],
  },
  {
    id: 9,
    name: "Polícia Militar do Estado",
    email: "comando@pm.sp.gov.br",
    type: "PJ",
    phone: "(11) 3327-7000",
    document: "04.266.388/0001-43",
    cep: "01139-001",
    logradouro: "Praça Coronel Fernando Prestes",
    numero: "115",
    bairro: "Bom Retiro",
    cidade: "São Paulo",
    estado: "SP",
    responsibles: [
      {
        id: 1,
        departamento: "Comando Geral",
        nome: "",
        cargo: "Comandante Geral",
        tratamento: "Excelentíssimo Senhor Comandante",
      },
      {
        id: 2,
        departamento: "Estado Maior",
        nome: "Cel. Marcos",
        cargo: "Chefe do Estado Maior",
        tratamento: "Ilustríssimo Senhor Coronel",
      },
    ],
  },
  {
    id: 10,
    name: "Sindicato dos Trabalhadores (SINDITRAB)",
    email: "presidencia@sinditrab.org.br",
    type: "PJ",
    phone: "(31) 3222-1111",
    document: "17.333.222/0001-55",
    cep: "30140-071",
  ...
  },
  {
    ...
    email: "carlos.eduardo@engenharia.com",
    type: "PF",
    phone: "(41) 96666-5555",
  ...
  },
  {
    ...
    email: "pgj@mpsp.mp.br",
    type: "PJ",
    phone: "(11) 3119-9000",
    document: "01.468.760/0001-90",
    cep: "01002-040",
    ...
    responsibles: [
      {
        id: 1,
        departamento: "Procuradoria-Geral de Justiça",
        nome: "",
        cargo: "Procurador-Geral de Justiça",
        tratamento: "Excelentíssimo Senhor Procurador-Geral",
      },
      {
        id: 2,
        departamento: "Promotoria de Justiça Criminal",
        nome: "Dra. Beatriz",
        cargo: "Promotora de Justiça",
        tratamento: "Excelentíssima Senhora Promotora",
      },
    ],
  },
  {
    id: 13,
    name: "Assembleia Legislativa do Estado (ALESP)",
    email: "contato@al.sp.gov.br",
    type: "PJ",
    phone: "(11) 3886-6000",
    document: "45.985.632/0001-08",
    cep: "04001-900",
