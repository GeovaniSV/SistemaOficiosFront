              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Gerencie os papéis de acesso e suas permissões no sistema.
                  </p>
                </div>
                ...
                {filteredRoles.length > itemsPerPage && (
                  <div className="px-6 py-4 border-t border-slate-200 flex items-center justify-between bg-slate-50">
                    <span className="text-sm text-slate-500">
                      ...
                      de {filteredRoles.length} registros
                    </span>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                      {isExistingRole
                        ...
                        : "Preencha os dados e defina as permissões do novo papel."}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 sm:p-8">
                <form onSubmit={handleSaveRole} className="space-y-8">
                  <div className="flex items-center justify-between bg-slate-50 p-4 rounded-xl border border-slate-200 mb-6">
                    ...
                    <label
                      className={`relative inline-flex items-center ${!isExistingRole ? "cursor-not-allowed opacity-70" : "cursor-pointer"}`}
                    >
                      <input
                        type="checkbox"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="md:col-span-2">
                      <label className="block text-sm font-medium text-slate-700 mb-1">
                        Nome do Papel <span className="text-rose-500">*</span>
                      </label>
                      <Input
                        type="text"
                        required
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                formData.permissions.usuarios?.ver || false
                              }
                              onChange={(e) =>
                                handlePermissionChange(
                                  "usuarios",
                          ...
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                formData.permissions.usuarios?.criar || false
                              }
                              onChange={(e) =>
                                handlePermissionChange(
                                  "usuarios",
                          ...
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                formData.permissions.usuarios?.editar || false
                              }
                              onChange={(e) =>
                                handlePermissionChange(
                                  "usuarios",
                          ...
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                formData.permissions.usuarios?.excluir || false
                              }
                              onChange={(e) =>
                                handlePermissionChange(
                                  "usuarios",
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                formData.permissions.templates?.ver || false
                              }
                              onChange={(e) =>
                                handlePermissionChange(
                                  "templates",
                          ...
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                formData.permissions.templates?.criar || false
                              }
                              onChange={(e) =>
                                handlePermissionChange(
                                  "templates",
                          ...
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                formData.permissions.templates?.editar || false
                              }
                              onChange={(e) =>
                                handlePermissionChange(
                                  "templates",
                          ...
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                formData.permissions.templates?.excluir || false
                              }
                              onChange={(e) =>
                                handlePermissionChange(
                                  "templates",
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <label className="flex items-center space-x-3 cursor-pointer">
                            <input
                              type="checkbox"
                              checked={
                                formData.permissions.configuracoes.acessar
                              }
                              onChange={(e) =>
                                handlePermissionChange(
                                  "configuracoes",
                            ...
                            />
                            <span className="text-sm text-slate-700">
                              Acessar e modificar configurações globais
                            </span>
                          </label>
                        </div>
                      </div>
