                      ...
                      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                          ...
                          <div className="md:col-span-8">
                            ...
                            <Input type="text" value={orgData.nome} disabled />
                          </div>
                          ...
                          <div className="md:col-span-3">
                            ...
                            <Input
                              ...
                              value={orgData.cep}
                              onChange={(e) =>
                                setOrgData({ ...orgData, cep: e.target.value })
                              }
                            />
                          </div>
                          ...
                          <div className="md:col-span-12">
                            ...
                            <p className="text-xs text-slate-500 mt-1">
                              Pressione Enter para adicionar uma cidade à lista.
                            </p>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                          <div className="md:col-span-12 pt-4 border-t border-slate-100">
                            <h4 className="text-md font-semibold text-slate-900 mb-4">
                              Aparência do Ofício (Pré-visualização e Impressão)
                            </h4>
