...
export default function Configuracoes() {
  ...
  const { data: usuariosList = [], isError: isUserError } = useUsuarios();
  const { data: cargosList = [], isError: isCargoError } = useCargos();
  const { data: smtpConfig, isLoading: isLoadingSmtp } = useSmtpConfig();
  const updateSmtpConfig = useUpdateSmtpConfig();
  const {
    data: oficioSettings,
    isLoading: isLoadingOficioSettings,
    isError,
    error,
  } = useOficioSettings();
  ...
  const handleRemoveCity = (cityToRemove: string) => {
    setOrgData({
      ...orgData,
      cidadesSubsecao: orgData.cidadesSubsecao.filter(
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex">
      ...
      <div className="flex-1 md:pl-64 flex flex-col min-h-screen w-full">
        ...
        {isError ? (
          <div className="px-6 py-8 text-center text-rose-500 justify-center">
            ...
            <div className="max-w-5xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Gerencie suas preferências, perfil e dados da organização.
                </p>
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="w-full md:w-64 shrink-0">
                  <nav className="flex flex-col space-y-1">
                    ...
                    >
                      <Building2
                        className={`w-5 h-5 mr-3 ${activeTab === "organizacao" ? "text-emerald-600" : "text-slate-400"}`}
                      />
                      Organização
                    </button>
                    <button
                    ...
                    >
                      <FileText
                        className={`w-5 h-5 mr-3 ${activeTab === "oficios" ? "text-emerald-600" : "text-slate-400"}`}
                      />
                      Ofícios
                    </button>
                    <button
                    ...
                    >
                      <Mail
                        className={`w-5 h-5 mr-3 ${activeTab === "email" ? "text-emerald-600" : "text-slate-400"}`}
                      />
                      Servidor de E-mail
                    </button>
                  </nav>
                      ...
                      {activeTab === "organizacao" && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4">
                          <div>
                            ...
                            <p className="text-sm text-slate-500 mt-1">
                              Informações que aparecerão nos cabeçalhos dos
                              ofícios.
                            </p>
                          </div>
                            ...
                            <div className="md:col-span-12 flex items-center gap-6 pb-6 border-b border-slate-100">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1 max-w-md">
                                  Esta imagem será exibida no cabeçalho dos
                                  ofícios gerados. Recomendamos uma imagem com
                                  fundo transparente (PNG) e tamanho máximo de
                                  2MB.
                                </p>
                                {orgData.logo && (
                                  <button
                            ...
                            <div className="md:col-span-12">
                              ...
                              <div className="p-2 bg-white border border-slate-200 rounded-lg focus-within:ring-2 focus-within:ring-emerald-500/20 focus-within:border-emerald-500 transition-colors min-h-[42px] flex flex-wrap gap-2">
                                {orgData.cidadesSubsecao.map((city) => (
                                  <span
                                    key={city}
                                    className="inline-flex items-center px-2.5 py-1 rounded-md text-sm font-medium bg-emerald-100 text-emerald-800"
                                  >
                                    {city}
                                    <button
                                      type="button"
                                ...
                                <Input
                                  ...
                                  placeholder={
                                    orgData.cidadesSubsecao.length === 0
                              ...
                              <p className="text-xs text-slate-500 mt-1">
                                Pressione Enter para adicionar uma cidade à
                                lista.
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                            <div className="md:col-span-12 pt-4 border-t border-slate-100">
                              <h4 className="text-md font-semibold text-slate-900 mb-4">
                                Aparência do Ofício (Pré-visualização e
                                Impressão)
                              </h4>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                <div className="md:col-span-12">
                                  ...
                                  />
                                  <p className="text-xs text-slate-500 mt-1">
                                    Este texto aparecerá no topo de todos os
                                    ofícios gerados.
                                  </p>
                                </div>
                                ...
                                <div className="md:col-span-12">
                                  ...
                                  />
                                  <p className="text-xs text-slate-500 mt-1">
                                    Este texto aparecerá na parte inferior de
                                    todos os ofícios gerados.
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="md:col-span-12 pt-4 border-t border-slate-100">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                ...
                                >
                                  <label className="block text-sm font-medium text-slate-700 mb-1">
                                    Pessoas/Cargos Autorizados a Assinar
                                  </label>
                                  <div className="p-2 bg-white border border-slate-200 rounded-lg focus-within:ring-2 focus-within:ring-emerald-500/20 focus-within:border-emerald-500 transition-colors min-h-[42px] flex flex-wrap gap-2">
