...
export function ContatoResponsibleModal({
  isOpen,
  onClose,
  responsible,
  onSave,
}: ContatoResponsibleModalProps) {
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-lg overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="p-6 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">
                Tratamento <span className="text-rose-500">*</span>
              </label>
              <Input
                type="text"
                value={currentResponsible.treatment || ""}
                onChange={(e) =>
                  setCurrentResponsible({
                    ...currentResponsible,
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">
                Cargo / Posição <span className="text-rose-500">*</span>
              </label>
              <Input
                type="text"
                value={currentResponsible.position || ""}
                onChange={(e) =>
                  setCurrentResponsible({
                    ...currentResponsible,
            ...
            <div className="sm:col-span-2">
              ...
              <Input
                type="text"
                value={currentResponsible.department || ""}
                onChange={(e) =>
                  setCurrentResponsible({
                    ...currentResponsible,
