...
export default function ArquivarOficio() {
  ...
  const handleSave = (e: React.FormEvent) => {
    ...
    const senderName = selectedSender
      ? `${selectedSender.responsibleName} (${selectedSender.name}${selectedSender.subArea ? ` - ${selectedSender.subArea}` : ""})`
      : senderSearch;
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Registre um ofício recebido de outra instituição.
                  </p>
                </div>
              </div>
                        ...
                        <ul className="max-h-60 overflow-y-auto py-1">
                          ...
                          {mockDestinatarios.filter(
                            ...
                            <li className="px-4 py-8 text-center text-sm text-slate-500">
                              Nenhum remetente encontrado. Você pode manter o
                  ...
                  {!pdfFile ? (
                    ...
                    >
                      ...
                      <p className="text-sm text-slate-500">
                        Selecione o arquivo PDF escaneado ou original
                      </p>
                    </div>
                  ) : (
